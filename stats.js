var Stats = function () {
  // Fungsi untuk mengatur warna data (menggeser warna)
  function s(a, g, d) {
    var f, c, e;
    
    // Menggeser data warna
    for (c = 0; c < 30; c++) {
      for (f = 0; f < 73; f++) {
        e = (f + c * 74) * 4;
        a[e] = a[e + 4];
    ...
    // Menyimpan warna berdasarkan kondisi
    for (c = 0; c < 30; c++) {
      e = (73 + c * 74) * 4;
      if (c < g) {
        a[e] = b[d].bg.r;
  ...
  // Variabel untuk mengatur statistik
  var r = 0,
    t = 2,
    g,
    u = 0,
    ...
    w = 1E3,
    x = 0,
    k, d, a, m, y, n = 0, z = 1E3, A = 0, f, c, o, B, p = 0, C = 1E3, D = 0, h, i, q, E;
  ...
  // Membuat elemen div untuk menampilkan statistik
  ...
  g.addEventListener("click", function () {
    ...
    // Mengatur tampilan berdasarkan klik
    switch (r) {
      case 0:
  ...
  // Mengembalikan elemen dan fungsi untuk memperbarui statistik
  return {
    domElement: g,
    update: function () {
      u++;
